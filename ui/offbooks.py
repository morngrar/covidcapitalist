...
import pygame
from ui import colors, textwrap
...
class OffBooksProducerBox:
    """Box which displays an off-the-books producer-item"""
    ...
    def draw(self):
        if not self.pos:
            raise ValueError("OffBooksProducerBox must have position")
